...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "rm_scan_receipts_title": {"zh": "ArXiv 扫描收据", "en": "ArXiv Scan Receipts"},
    "rm_scan_receipts_hint": {
        "zh": "每次日报的领域级抓取证据：用于区分真实低产、历史去重与抓取失败。收据不替代交付历史。",
        "en": "Per-domain evidence for each daily arXiv scan. It distinguishes a quiet day, history de-duplication, and fetch failure; it does not replace delivery history.",
    },
    "rm_scan_receipts_empty": {
        "zh": "尚无可显示的 ArXiv 扫描收据；下一次启用持久化的日报运行后会出现。",
        "en": "No ArXiv scan receipt is available yet. It will appear after the next persistent daily run.",
    },
